...
required=['README.md','LICENSE','.env.example','docs/booking/AUTONOMOUS_BOOKING_AGENT_PLAN.md','docs/booking/HUMAN_APPROVAL_LEDGER.md','docs/booking/BOOKING_ONE_SHEET_TEMPLATE.md','docs/booking/ASSET_ATTACHMENT_APPROVAL_CHECKLIST.md','framework/prompts/booking-agent-prompts.md','framework/payloads/booking-lead.payload.example.json','framework/payloads/booking-campaign.payload.example.json','framework/tags/booking-tags.json','docs/index.html']
